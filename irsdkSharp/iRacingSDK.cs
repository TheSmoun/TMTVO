...
namespace iRSDKSharp
{
    ...
    public class iRacingSDK
    {
        ...
        public void BroadcastMessage(BroadcastMessageTypes msg, int var1, int var2)
        {
            ...
            {
                SendNotifyMessage(hwndBroadcast, msgId.ToInt32(), MakeLong((short)msg, (short)var1), var2);
            }
        }
        ...
        [DllImport("user32.dll")]
        private static extern IntPtr SendNotifyMessage(IntPtr hWnd, int Msg, int wParam, int lParam);
